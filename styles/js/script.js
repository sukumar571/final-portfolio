...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Nannam Sukumar";
            $("#favicon").attr("href", "/styles/images/about.jpeg");
        }
        else {
...
async function fetchData(type = "skills") {
    ...
    type === "skills" ?
        ...
        :
        response = await fetch("./final portfolio/projects.json")
...
function showProjects(projects) {
    ...
    projects.slice(0, 10).filter(project => project.category != "android").forEach(project => {
        projectHTML += `
        <div class="box tilt">
      <img draggable="false" src="/styles/images/projects/${project.image}.png" alt="project" />
      <div class="content">
        <div class="tag">
        <h3>${project.name}</h3>
        </div>
